...
export default {
  ...
  created () {
    get('https://api.openweathermap.org/data/2.5/weather?lat='+ this.coords.latitude +'&lon=' + this.coords.longitude + '&APPID=59b0d37a8bb62db251652e421b20342a&units=metric').then(response => {
